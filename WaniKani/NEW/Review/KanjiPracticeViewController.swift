...
class KanjiPracticeViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    swipeLeftGesture = UISwipeGestureRecognizer(target: self, action: #selector(KanjiPracticeViewController.swipeLeft))
    swipeLeftGesture.direction = UISwipeGestureRecognizerDirection.Left
    swipeRightGesture = UISwipeGestureRecognizer(target: self, action: #selector(KanjiPracticeViewController.swipeRight))
