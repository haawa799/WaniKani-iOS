...
characterStyle.innerHTML = "div#character {vertical-align: middle;text-align: center;} div.vocabulary span {font-size: FFF%;height: HHHpx;width: WWWpx;display:table-cell;  vertical-align: middle;  text-align: center;} div.kanji span {font-size: FFF%;height: HHHpx;width: WWWpx;display:table-cell;  vertical-align: middle;  text-align: center;} div.radical span {font-size: FFF%;height: HHHpx;width: WWWpx;display:table-cell;  vertical-align: middle;  text-align: center;}";
